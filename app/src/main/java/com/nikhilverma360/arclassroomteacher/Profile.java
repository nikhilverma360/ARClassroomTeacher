    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),CreateClassroom.class);
        ...
        if(signInAccount != null){
            ...
            CollectionReference myClassesRef = db.collection("users").document(Objects.requireNonNull(signInAccount.getId())).collection("classes");
